...
urlpatterns = [    
    ...
    path('credential/qr/download/<str:credential_id>/', QRCodeDownloadView.as_view(), name='download_credential_qr'),
    # Add an API prefix version for consistency
    path('api/credential/qr/download/<str:credential_id>/', QRCodeDownloadView.as_view(), name='api_download_credential_qr'),
